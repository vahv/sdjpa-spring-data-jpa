...
public class AuthorDaoImpl implements AuthorDao {
    ...
    @Override
    public List<Author> findAllAuthorsByLastNameNative(String lastname, Pageable pageable) {
        return authorRepository.findAllAuthorsByLastNameNativeQueryPageable(lastname, pageable).getContent();
    }
